...
\FPeval{\perfRSAEnc}{clip(round((\rsaEncryptMaxValue - (\rsaEncMesaureMax + \rsaEncMesaureMin + \rsaEncMesaureAverage) / 3), 5))}
...
\FPeval{\perfRSADec}{clip(round((\rsaDecryptMaxValue - (\rsaDecMesaureMax + \rsaDecMesaureMin + \rsaDecMesaureAverage) / 3), 5))}
