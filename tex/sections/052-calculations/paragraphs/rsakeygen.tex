...
\FPeval{\perfDevRSAKeyGen}{clip(round((\rsaKeyGenerationMaxValue - (\rsaKeyGenMesaureMax + \rsaKeyGenMesaureMin + \rsaKeyGenMesaureAverage) / 3), 5))}
...
\FPeval{\perfDevAESKeyGen}{clip(round((\aesKeyGenerationMaxValue - (\aesKeyGenMesaureMax + \aesKeyGenMesaureMin + \aesKeyGenMesaureAverage) / 3), 5))}
