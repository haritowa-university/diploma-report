\FPeval{\developerHourPriceValue}{clip(round((\totalPowerConsumptionDevelopment * \developerHourRateValue * (1 + \bonuceRateCoefValue) * (1 + \additionalSalaryCoefValue) * (1 + \salaryFundCoefValue)), 2))}
