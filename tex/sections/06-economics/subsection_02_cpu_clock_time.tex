...
Рассчитаем расходы на~электроэнергию за час работы ПК, подставив значения в~формулу \formularef{energyHourCostEquation}:
...
Рассчитаем годовые затраты на~ремонт и~техническое обслуживание ПК, подставив значения в~формулу \formularef{pcSupportCostEquation}:
